...
def load_and_validate(file_path, category, config_dict):
    ...
    if (
        ("Num_Acc" in mandatory)
        and ("Num_Acc" not in df.columns)
        and ("Accident_Id" in df.columns)
    ):
